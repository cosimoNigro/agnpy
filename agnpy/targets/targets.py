...
class SSDisk:
    ...
    @staticmethod
    def evaluate_multi_T_bb(nu, z, M_BH, m_dot, R_in, R_out, d_L):
        r"""evaluate a multi-temperature black body in the case of the SS Disk.
    ...
    @staticmethod
    def evaluate_multi_T_normalised_bb(nu, z, L_disk, M_BH, m_dot, R_in, R_out, d_L):
        """renormalise the SS Disk thermal SED to have total luminosity L_disk"""
        sed_disk = SSDisk.evaluate_multi_T_bb(nu, z, M_BH, m_dot, R_in, R_out, d_L)
        # renormalise
    ...
    def sed_flux(self, nu, z):
        ...
        return SSDisk.evaluate_multi_T_normalised_bb(
