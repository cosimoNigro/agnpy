...
.. toctree::
   ...
   tutorials/ec_gammapy_fit.ipynb
...
* `e2dnde`, representing the lower error on the energy flux (`erg / (cm2 s)`);
* `e2dnde`, representing the higher error on the energy flux (`erg / (cm2 s)`);
